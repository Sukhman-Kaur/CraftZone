...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div class="col-md-9">
                <div class="card">
                    <div class="card-header" style="border-bottom:3px solid orange;font-weight:bold;">
                        <strong>Create Advertisement</strong>
                    </div>
                    <div class="card-body" style="background-color:rgb(57,57,57);color:whitesmoke">
                        <ul class="nav nav-tabs">
                            <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#home" style="font-weight: bold; color:rgb(233, 154, 6)">Paper Crafts</a>
                            </li>
                        </ul>
                             ...
                             <div class="" id="home">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <label class="radio-inline"><input type="radio" name="customisation" value="yes">Yes</label>
                                        <label class="radio-inline"><input type="radio" name="customisation" value="no">No</label>
                                        </div>
                                        </div>
                                        <label style="padding:23px;"></label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                <label><strong>Photos of your Craft (Max 4)</strong></label>
